...
public class VerifyApplicationTokenOperationTest 
{

    @GeneratePojo
    private VerifyApplicationTokenRequest request;
    
    private VerifyApplicationTokenOperation instance;
    
    @Before
    public void setUp()
    {
        instance = new VerifyApplicationTokenOperation();
    }

    @Test
    public void testProcess() throws Exception
    {
        VerifyApplicationTokenResponse response = instance.process(request);
